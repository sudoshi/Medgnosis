...
import { ChartBarIcon, ClipboardDocumentCheckIcon, ComputerDesktopIcon, BanknotesIcon } from '@heroicons/react/24/outline';
...
export default function MeasuresMipsPage() {
  return (
    <div className="max-w-6xl mx-auto p-6">
      {/* MIPS Overview */}
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-3">Merit-based Incentive Payment System (MIPS)</h1>
        <p className="text-dark-text-secondary mb-4">
          A program that evaluates the performance of Medicare Part B clinicians using a composite score to determine payment adjustments.
        </p>
      </div>
        ...
        <div className="panel-analytics relative">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-sm text-dark-text-secondary">Weight</div>
          ...
          <div className="mt-2 text-right text-sm text-dark-text-secondary">
            Score: 75/100
          </div>
        </div>
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-semibold">Improvement Activities</h2>
              </div>
              <p className="text-dark-text-secondary mt-2">
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-semibold">Promoting Interoperability</h2>
              </div>
              <p className="text-dark-text-secondary mt-2">
      ...
      <div className="panel-base relative mb-8">
        <h2 className="text-xl font-semibold mb-4">MIPS Composite Score</h2>
        ...
        <div className="mt-4 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
          <div className="text-green-500 font-semibold">Positive Payment Adjustment</div>
          <p className="text-dark-text-secondary mt-1">
            Based on your composite score, you are eligible for a positive payment adjustment in the next payment year.
          </p>
        </div>
      </div>
    </div>
