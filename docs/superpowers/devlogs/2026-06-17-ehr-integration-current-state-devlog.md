...
- Non-EMPI mutation audit hardening is staged in this continuation: CDS feedback route audit, request-helper-backed admin measure refresh audit, and PHI-safe aggregate/bound audit details for clinical notes, generated orders, cohorts, population finder, MTM, auto-orders, invite activation, and refresh-token branches.
