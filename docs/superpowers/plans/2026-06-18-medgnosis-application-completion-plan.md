...
- [ ] Add external alerts, stale-data runbook depth, and remaining EDW/local-matching breadth for tenant-specific patient-detail needs.
...
- Data risk: Bulk Data kickoff/poll/import/scheduling can create a false sense of production readiness until vendor sandbox evidence, incident-tested replay/dead-letter workflows, tombstone behavior, stale-data runbooks, external alerting, and operator use of the new run-detail surface are proven.
