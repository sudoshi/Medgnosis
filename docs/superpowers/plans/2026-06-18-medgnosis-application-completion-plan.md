...
- EHR integration risk: SMART launch can appear complete while still lacking vendor sandbox evidence, remaining FHIR-read/token audit surfaces, configured external alert delivery, access-policy attribution, and tenant-specific EDW/local-matching breadth.
